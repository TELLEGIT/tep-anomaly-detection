...
```
 ...
 [Feed A/D/E]      [Feed C]      [Feed B]
      ...
      | xmeas_7  : Pressure              |
      | xmeas_9  : Temperature           |
      | xmv_10   : Cooling Water Flow    |
      | xmv_11   : Agitator Speed        |
      +----------------+-----------------+
                       |
                       v
      +----------------------------------+
      ...
      |           Separator              |
      | xmeas_15 ~ xmeas_17              |
      | xmeas_17 : Separator Temp        |
      +----------------+-----------------+
                       |
             +---------+---------+
             |                   |
             v                   v
      Recycle Compressor     Purge Stream
      xmv_5 : Speed
             |
             v
      +----------------------------------+
